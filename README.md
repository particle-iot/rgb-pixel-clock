...
To complete the RGB Pixel Clock kit, it is recommended to flash the [RGBPongClock](https://build.particle.io/libs/573f856ccbc9f2c1f30011f1/tab/1_RGBPongClock.ino) to your Particle device. However, the kit may also be used with the community supplied [Live Sports Scoreboard](https://community.particle.io/t/live-sports-scoreboard/19817) app.  Please feel free to use these or create your own to contribute back to the community!
