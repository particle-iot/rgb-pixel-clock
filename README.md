...
The RGB Pixel Clock Kit can be used stand-alone with several community-created libraries (eg. RGB Pong Clock) and is included in the [Word Clock (kit)](http://github.com/particle-iot/wordclock) featured for the first time at the San Francisco 2016 Maker Faire.  
